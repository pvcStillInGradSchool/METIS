...
VectorPtr Construct(idx_t capacity) {
  VectorPtr this;
...
void Destruct(VectorPtr this) {
  free(this->array_);
  free(this);
}
void Enlarge(VectorPtr this) {
  idx_t* new_array;
  this->capacity_ *= 2;
...
void PushBack(VectorPtr this, idx_t x) {
